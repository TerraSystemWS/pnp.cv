...
const VpublicaDetalhes = ({ social, contato, inscricao, navbar }: any) => {
	...
	const excluirPrivados = (title: String): boolean => {
		...
		for (let index = 0; index < substr.length; index++) {
			title_clean = title
				.toLowerCase()
				.includes(substr[index].toLowerCase());
			if (title_clean) {
				break;
			}
		}
	...
	return (
		<Layout rsocial={social} contato={contato} navbar={navbar} user={user}>
			<Head>
				<title>
					{inscricao.data?.attributes?.nome_projeto} - Prémio Nacional
					De Publicidade
				</title>
				<meta
					name="description"
									...
									<div className="md:col-span-1">
										<div className="px-4 sm:px-0">
											...
											<p className="mt-1 text-sm text-gray-600">
												Concurso do Prémio Nacional de
												Publicidade
											</p>
										</div>
									</div>
								...
								<div className="md:grid md:grid-cols-3 md:gap-6">
									<div className="md:col-span-1">
										<div className="px-4 sm:px-0">
											...
											<p className="mt-1 text-sm text-gray-600">
												Informações sobre as equipas e
									...
									{inscricao.data.attributes.fileLink &&
										inscricao.data.attributes.fileLink.map(
											(value: any, index: number) => {
												...
												const string_bruto: string =
													value.file_link.substr(
														value.file_link.length -
															4
													);
									...
									<div className="px-4 sm:px-0">
										...
										<p className="mt-1 text-sm text-gray-600">
											...
											<p className="mb-2">
												...
												Após digitar o seu email use o
												botao de &quot;votar&quot; para
												enviar o seu voto
											</p>
											<p className="mb-2">
												...
												A votação só pode ser feita uma
												única vez
											</p>
											<p className="mb-2">
												<span className="text-red-500 font-bold text-lg">
