				...
				if (result.isConfirmed) {
					...
					if (Status == 200) {
						...
						var Difference_In_Time =
							data_fim.getTime() - data_inicio.getTime();
						...
						<div className="md:col-span-1">
							<div className="px-4 sm:px-0">
								...
								<p className="mt-1 text-sm text-gray-600">
									Para aceder a sua inscrição introduza o
									codigo que foi criado como participante do
									PNP, use esse codigo para verificar a sua
									inscrição e ou fazer alterações
								</p>
							</div>
						</div>
					...
					<div className="md:grid md:grid-cols-3 md:gap-6">
						<div className="md:col-span-1">
							<div className="px-4 sm:px-0">
								...
								<p className="mt-1 text-sm text-gray-600">
									Crie a sua inscrição para o prémio nacional
									publicidade
								</p>
							</div>
						</div>
