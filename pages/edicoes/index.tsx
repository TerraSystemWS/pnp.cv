			...
			<div className="container mx-auto">
				<div className="bg-gray-50 py-12 px-4 sm:px-6">
					...
					<div className="font-light text-gray-500 sm:text-xl dark:text-gray-400">
						Fotografias, videos, regulamento, os vencedores dos
						Prémios Palmeira e respetivos discursos de vitória… Aqui
						encontra tudo sobre as anteriores edições do PNP.
					</div>
				</div>
			</div>
