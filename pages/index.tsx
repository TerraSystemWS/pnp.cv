				...
				<div className="bg-gray-50">
					<div className="mx-auto max-w-7xl py-12 px-4 sm:px-6">
						...
						<div className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">
							O PRÉMIO NACIONAL DE PUBLICIDADE tem por objeto a
							promoção da atividade publicitária, através do
							reconhecimento da qualidade dos trabalhos
							publicitários e institucionais exibidos e
							veiculados, premiando os que pela sua criatividade e
							originalidade contribuem para o desenvolvimento do
							mercado publicitário em Cabo Verde.
						</div>
					</div>
				</div>
			</div>
				...
				<div className="container px-5 py-24 mx-auto">
					<div className="text-center mb-20">
						...
						<p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
							O Prémio Público de Publicidade é uma das categorias
							do Prémio Nacional de Publicidade (PNP) em que a
							votação é feita somente pelo público, através da
							internet. Trata-se de um prémio da responsabilidade
							do PNP, com regulamento próprio, sem avaliação do
