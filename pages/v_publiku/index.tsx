        ...
        <Layout rsocial={social} contato={contato} navbar={navbar}>
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
					<div className="mx-auto max-w-screen-md text-center lg:mb-16 mb-8">
                        ...
                        O Prémio Público de Publicidade é uma das categorias do Prémio Nacional de Publicidade (PNP) em que a votação é feita somente pelo público, através da Internet. Trata-se de um prémio da responsabilidade do PNP, com regulamento próprio, sem avaliação do júri, baseado apenas no critério de popularidade.
						</p>
					</div>
                <div className="dados das inscriçoes">
                    ...
                    <div className="flex-none w-48 relative">
                        <img src="https://res.cloudinary.com/dkz8fcpla/image/upload/v1674656587/pnp-icon.png" alt="" className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
                    </div> 
                    <form className="flex-auto p-6">
                        ...
                        <div className="w-full flex-none text-sm font-medium text-slate-700 mt-2">
                            ...
                            <p><IoCall/> {value.attributes.telefone}</p>
                        </div>
                        </div>
                        ...
                        <div className="flex-auto flex space-x-4">
                            <Link href={`/v_publiku/${value.id}`} className="bg-amarelo-ouro text-branco hover:text-branco font-[Poppins] py-2 px-6 rounded md:ml-8 hover:bg-castanho-claro 
                                            duration-500">
                            Detalhes
                            </Link>
                        ...
                        <button onClick={like} className="flex-none flex items-center justify-center w-9 h-9 rounded-md text-slate-300 border border-slate-200" type="button" aria-label="Like">
                            <svg width="20" height="20" fill={cor} aria-hidden="true">
