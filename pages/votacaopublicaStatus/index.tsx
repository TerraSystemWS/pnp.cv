      ...
      /> */}
		...
		return (
			...
			>
				<Head>
					<title>
						Resultado Da Votaçao Publica - Prémio Nacional De
						Publicidade
					</title>
				</Head>
...
export async function getServerSideProps() {
	...
	const posts = await fetcher(`${api_link}/api/posts?populate=*`);
	// GET: dados do navbar
	...
	const Vpublica = await fetcher(`${api_link}/api/inscricoes?${query}`);
